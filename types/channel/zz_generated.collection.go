...
func Filter[T any](xs Chan[T], fn func(T) bool) Chan[T] {
...
func Max[T any](ord cmp.Ord[T]) func(xs Chan[T]) (T, bool) {
	return func(xs Chan[T]) (T, bool) {
...
// It returns <zero value>, false if the collection is empty.
func MaxBy[T any](xs Chan[T], less func(T, T) bool) (T, bool) {
	return iterator.MaxBy(xs.Iter(), less)
}

// Min returns the smallest element with respect to the given Ord.
// It returns <zero value>, false if the collection is empty.
func Min[T any](ord cmp.Ord[T]) func(xs Chan[T]) (T, bool) {
	return func(xs Chan[T]) (T, bool) {
...
// It returns <zero value>, false if the collection is empty.
func MinBy[T any](xs Chan[T], less func(T, T) bool) (T, bool) {
	return iterator.MinBy(xs.Iter(), less)
}

// Sum sums up all values in xs.
// It returns m.Empty() when xs is empty.
func Sum[T any](m algebra.Monoid[T]) func(xs Chan[T]) T {
	return func(xs Chan[T]) T {
...
func SumWithInit[T any](s algebra.Semigroup[T]) func(init T, xs Chan[T]) T {
	return func(init T, xs Chan[T]) T {
