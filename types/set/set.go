...
//go:generate gotip run ../../cmd/gen-collection -pkg set -name Set -constraint comparable -include Find,FindElem,Fold,Map,Sum,SumWithInit -out zz_generated.collection.go
